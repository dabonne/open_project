...
import img1 from '../../../assets/carousel/student.png'
import img2 from '../../../assets/carousel/2.jpg'
import img3 from '../../../assets/carousel/3.jpg'
const Carousel = () => {


    return <div id="myCarousel" className="carousel slide mb-6 mb-5" data-bs-ride="carousel">
        ...
        <div className="carousel-inner">
            <div className="carousel-item active">
                ...
                <img width={"100%"} className="bd-placeholder-img" src={img1} />
